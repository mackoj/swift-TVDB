...
extension TVDB.Users {
    ...
    public enum GetUser {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = TVDBUserData

            /** User information. */
            case status200(TVDBUserData)
            ...
            public var success: TVDBUserData? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBUserData.self, from: data))
