...
extension TVDB.Users {
    ...
    public enum DeleteUserFavoritesById {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = TVDBUserFavoritesData

            /** List of user favorites. */
            case status200(TVDBUserFavoritesData)
            ...
            case status409(TVDBConflict)

            public var success: TVDBUserFavoritesData? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBUserFavoritesData.self, from: data))
                ...
                case 409: self = try .status409(decoder.decode(TVDBConflict.self, from: data))
