...
extension TVDB.Authentication {
    ...
    public enum PostLogin {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: TVDBAuth

            public init(body: TVDBAuth) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public var responseResult: APIResponseResult<TVDBToken, TVDBNotAuthorized> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBToken.self, from: data))
