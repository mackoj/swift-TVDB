...
extension TVDB.Series {
    ...
    public enum GetSeriesByIdEpisodesQuery {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = TVDBSeriesEpisodesQuery

            /** An array of basic Episode results that matched the query */
            case status200(TVDBSeriesEpisodesQuery)
            ...
            public var success: TVDBSeriesEpisodesQuery? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBSeriesEpisodesQuery.self, from: data))
