...
extension TVDB.Series {
    ...
    public enum GetSeriesByIdImages {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = TVDBSeriesImagesCounts

            /** A summary of the image types and counts available for the given series. */
            case status200(TVDBSeriesImagesCounts)
            ...
            public var success: TVDBSeriesImagesCounts? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBSeriesImagesCounts.self, from: data))
