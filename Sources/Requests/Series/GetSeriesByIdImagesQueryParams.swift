...
extension TVDB.Series {
    ...
    public enum GetSeriesByIdImagesQueryParams {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = TVDBSeriesImagesQueryParams

            /** An array of query keys as strings */
            case status200(TVDBSeriesImagesQueryParams)
            ...
            public var success: TVDBSeriesImagesQueryParams? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBSeriesImagesQueryParams.self, from: data))
