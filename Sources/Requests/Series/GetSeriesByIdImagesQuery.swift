...
extension TVDB.Series {
    ...
    public enum GetSeriesByIdImagesQuery {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = TVDBSeriesImageQueryResults

            /** An array of basic Episode results that matched the query */
            case status200(TVDBSeriesImageQueryResults)
            ...
            public var success: TVDBSeriesImageQueryResults? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBSeriesImageQueryResults.self, from: data))
