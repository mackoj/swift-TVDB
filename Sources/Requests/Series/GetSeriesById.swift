...
extension TVDB.Series {
    ...
    public enum GetSeriesById {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = TVDBSeriesData

            /** A series record. */
            case status200(TVDBSeriesData)
            ...
            public var success: TVDBSeriesData? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBSeriesData.self, from: data))
