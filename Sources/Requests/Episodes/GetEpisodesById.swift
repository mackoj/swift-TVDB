...
extension TVDB.Episodes {
    ...
    public enum GetEpisodesById {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = TVDBEpisodeRecordData

            /** An array of query keys as strings */
            case status200(TVDBEpisodeRecordData)
            ...
            public var success: TVDBEpisodeRecordData? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(TVDBEpisodeRecordData.self, from: data))
